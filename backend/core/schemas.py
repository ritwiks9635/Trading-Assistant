...
class NewsArticle(BaseModel):
    ...
    source: str
    region: Optional[str] = None  # e.g. "US", "IN", "EU"
...
class GPTInsight(BaseModel):
    ...
    high_potential_tickers: Optional[List[str]] = []  # Diversified suggestions
...
# ============================================================
# 6. Parsed Query Schema (Enhanced for Global Queries)
# ============================================================
class ParsedQuery(BaseModel):
    top_n_requested: Optional[int] = 5
    time_frame: Optional[str] = "today"       # today | this_week | this_month | long_term
    query_type: Optional[str] = "general"     # general | top_gainers | top_losers | dividend | budget_picks | news_driven
    company_mentioned: Optional[str] = None
    budget: Optional[float] = None
    market: Optional[str] = None
    sector: Optional[str] = None
    region: Optional[str] = None              # e.g. "US", "IN", "EU", "Global"
    criteria: Optional[str] = None            # e.g. "low cap", "high growth", "undervalued"
    metric_focus: Optional[str] = None        # e.g. "dividend yield", "P/E", "market cap"
...
# ============================================================
# 8. Stock Insight Schema (Global Enhanced)
# ============================================================
...
# ============================================================
# 13. Unified Trading State Model
# ============================================================
class TradingState(BaseModel):
    ...
    # Extended fields for global query awareness
